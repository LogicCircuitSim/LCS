...
class GATE extends BOARDOBJECT
    ...
    getHeight: (inputpincount) => @size.space * (4+(3*(inputpincount-1))) * (@size.scale/7)
    ...
    draw: =>
        ...
        @outputpin.pos = newpos(@pos.x + @getWidth(), @pos.y + (height/2))
    ...
    getOutputPinAt: (x,y) =>
        return @outputpin if lume.distance(x,y,@pos.x+@getWidth(),@pos.y+@getHeight()/2,false) < 10
...
class AND extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("AND", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class OR extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("OR", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class NAND extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("NAND", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class NOR extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("NOR", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class XOR extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("XOR", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class XNOR extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("XNOR", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class NOT extends GATE
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("NOT", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
...
class PERIPHERAL extends BOARDOBJECT
    ...
    getWidth: => @size.width*@size.scale
    getHeight: => @size.space * (4+(3*(math.max(@inputpincount, @outputpincount)-1))) * (@size.scale/7)
...
class INPUT extends PERIPHERAL
    new: (x,y,inputpincount=0,outputpincount=1) =>
        super x,y,inputpincount,outputpincount
...
class OUTPUT extends PERIPHERAL
    new: (x,y,inputpincount=1,outputpincount=0) =>
        super x,y,inputpincount,outputpincount
    ...
    drawMe: =>
        love.graphics.setColor(1, 1, 1)
        love.graphics.printCentered("OUT #{@id-2000}", @pos.x + (@getWidth()/2), @pos.y + (@getHeight()/2))
            

class BUFFER extends PERIPHERAL
    new: (x,y,inputpincount=1,outputpincount=1) =>
        super x,y,inputpincount,outputpincount
        @ticks = 5
        @tickcount = 0
        @isBuffering = false
